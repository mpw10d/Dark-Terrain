...
console.log('shiiiiiit')
    ...
    //You can add you name to the variable if you want to add yourself to the credits.
    
    //Variable for storing your Mapbox API Token
    var apitoken = 'pk.eyJ1IjoibXB3MTBkIiwiYSI6ImNrNDNteDlyaTA2cTIzbm12cWhyMXZmdzMifQ.fsIPIH1nF9RJ1CiNPUV-2A' 
    //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
